...
public class Acti_ChiTietSP extends AppCompatActivity {
    ...
    private void them_gio_hang(List<ProductHome.MauSchema> mauList) {
        ...
        btnthemgiohang.setOnClickListener(view -> {
            ...
            gioHang.setIdAccount(gioHang.getIdAccount()); // Thay thế bằng ID tài khoản thực
    ...
    private void addToCart(GioHangDTO gioHang) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://192.168.1.8:3000/") // Thay thế bằng URL cơ sở của bạn
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onFailure(@NonNull Call<Void> call, @NonNull Throwable t) {
                Toast.makeText(Acti_ChiTietSP.this, "Lỗi kết nối mạng!", Toast.LENGTH_SHORT).show();
            }
        });
    }
