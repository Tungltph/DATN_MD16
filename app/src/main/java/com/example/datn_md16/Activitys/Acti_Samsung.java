...
public class Acti_Samsung extends AppCompatActivity {
    ...
    private static final String TARGET_ID_HANG_SX = "6675aa0fff75b8dfd1e641e6";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.toolbarSamsung));
    ...
    private void fetchProducts() {
        ...
        call.enqueue(new Callback<List<ProductHome>>() {
            ...
            public void onResponse(Call<List<ProductHome>> call, Response<List<ProductHome>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (!filteredProducts.isEmpty()) {
                        iphoneAdapter = new IphoneAdapter(Acti_Samsung.this, filteredProducts);
            ...
            public void onFailure(Call<List<ProductHome>> call, Throwable t) {
                Toast.makeText(Acti_Samsung.this, "Lỗi kết nối: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
