...
public class Acti_vivo extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acti_vivo);
    ...
    private void fetchData() {
        ...
        call.enqueue(new Callback<List<ProductHome>>() {
            ...
            public void onFailure(Call<List<ProductHome>> call, Throwable t) {
                Toast.makeText(Acti_vivo.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
